...
from PyQt5.QtGui import QPainter,QPen,QPixmap,QBrush,QFontMetrics
...
##  ==============event处理函数==========================
   def paintEvent(self,event):  ##在窗口上绘图
      ...
      painter.setWindow(0,0,200,200) #设置窗口大小，逻辑坐标
...
#      pen.setWidth(2)   #线宽
      ...
      pix = QPixmap("D:/code_py/Fatigue Systemdemo/ui/border.png")
      painter.drawPixmap( 5, 8, 196, 196, pix )
...
#         //计算总范围角度,当前值范围角度,剩余值范围角度
         angleCurrent = 1.80 * self.__powerLevel
         rect = QRect( 20, 20, radius * 2, radius * 2)
#         //绘制圆弧进度
         painter.drawChord(rect, ( 270-angleCurrent)*16, angleCurrent*16*2 )
...
##绘制电量百分比文字
      ...
      painter.drawText( 100-textRect.width()/2, 100+textRect.height()/2,powStr)
